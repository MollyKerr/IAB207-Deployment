...
def create_app():
    ...
    def not_found(e): 
      return render_template("error_404.html", error_1=e)
    
    @app.errorhandler(500) # add into group assignment
    def internal_server_error(f):
      return render_template("500.html", error_2=f)
